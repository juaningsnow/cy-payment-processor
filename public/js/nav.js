...
vue__WEBPACK_IMPORTED_MODULE_1__.default.filter("numeric", function (value) {
...
new vue__WEBPACK_IMPORTED_MODULE_1__.default({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/credit-notes?status='AUTHORISED'").then(function (response) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/invoice-batches?not-yet-generated=1").then(function (response) {
      _this.invoiceBatchCount = response.data.meta.total;
    });
  }
});
})();
