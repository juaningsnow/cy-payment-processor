...
new vue__WEBPACK_IMPORTED_MODULE_5__.default({
  ...
  methods: {
    update: function update() {
      ...
      this.form.patch("/api/invoices/" + this.form.id).then(function (response) {
        _this.$swal({
  ...
  created: function created() {
    ...
    if (id != null) {
      ...
      this.isEdit = true;
      this.form.get("/api/invoices/" + id + "?include=supplier").then(function (response) {
    ...
    this.form.get("/api/suppliers?limit=".concat(Number.MAX_SAFE_INTEGER)).then(function (response) {
      _this2.supplierSelections = response.data;
      _this2.suppliersInitialized = true;
    });
