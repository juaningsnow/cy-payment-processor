...
new vue__WEBPACK_IMPORTED_MODULE_4__.default({
  ...
  methods: {
    store: function store() {
      ...
      this.form.post("/api/currencies").then(function (response) {
        _this.$swal({
          title: "Currency created!",
          text: "Currency was saved.",
          type: "success"
        }).then(function () {
          return window.location = "/currencies";
        });
      })["catch"](function (error) {
        console.log(error);
      });
    ...
    update: function update() {
      ...
      this.form.patch("/api/currencies/" + this.form.id).then(function (response) {
        _this2.$swal({
          title: "Currency updated!",
          text: "Changes saved to database.",
          type: "success"
        }).then(function () {
          return window.location = "/currencies/" + id;
        });
      });
    },
    ...
    load: function load() {
      ...
      this.isEdit = true;
      this.form.get("/api/currencies/" + this.form.id).then(function (response) {
  ...
  created: function created() {
    ...
    if (id != null) {
      this.dataInitialized = false;
      this.isEdit = true;
      this.form.get("/api/currencies/" + id).then(function (response) {
