    ...
    _c("tr", [
      ...
      _c("td", { attrs: { colspan: "3" } }, [
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "text", disabled: _vm.isShow, placeholder: "Remarks" },
          ...
          on: {
            input: function($event) {
              ...
              _vm.$set(_vm.detail, "description", $event.target.value)
            }
          }
        })
      ])
...
/* harmony import */ var _components_InvoiceBatchDetail_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/InvoiceBatchDetail.vue */ "./resources/js/components/InvoiceBatchDetail.vue");
...
new vue__WEBPACK_IMPORTED_MODULE_6__.default({
  ...
  components: {
    ...
    InvoiceBatchDetail: _components_InvoiceBatchDetail_vue__WEBPACK_IMPORTED_MODULE_4__.default,
  ...
  created: function created() {
    ...
    if (id != null) {
      ...
      this.isEdit = true;
      this.form.get("/api/invoice-batches/".concat(id, "?include=invoiceBatchDetails.invoice.supplier")).then(function (response) {
