...
vue__WEBPACK_IMPORTED_MODULE_2__.default.use(vue_sweetalert2__WEBPACK_IMPORTED_MODULE_1__.default);
...
new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  methods: {
    revokeApiConnection: function revokeApiConnection() {
      var _this = this;

      this.form.showAlert('Revoke Xero Api Connection?').then(function (response) {
        if (response.value) {
          _this.form.post('/api/companies/revoke').then(function (response) {
            _this.$swal({
              title: "Success",
              text: "Xero Connection has been revoked!",
              type: "success"
            }).then(function () {
              return window.location = "/xero/";
            });
          });
        }
      });
